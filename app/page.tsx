        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold">Company Inc.</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left">
              <h2 className="text-2xl font-bold">Company Inc.</h2>
            ...
            <div className="mt-6 md:mt-0 text-center md:text-right">
              <p className="text-blue-300">© {new Date().getFullYear()} Company Inc. All rights reserved.</p>
              <p className="mt-2 text-sm text-blue-400">123 Tech Street, Toronto, ON</p>
              <p className="text-sm text-blue-400">contact@companyinc.com</p>
            </div>
          </div>
        </div>
      </footer>
