  ...
  const testimonials = [
    {
      ...
      quote:
        "Company Inc. transformed our IT infrastructure, resulting in a 30% increase in operational efficiency. Their team's expertise and dedication were exceptional throughout the project.",
    },
    {
      name: "Michael Chen",
      company: "Global Finance Partners",
      quote:
        "The cybersecurity solutions implemented by Company Inc. have given us peace of mind. Their proactive approach to security has protected us from multiple potential threats.",
    },
    {
